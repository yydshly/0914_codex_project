# draw.io IR — research\.drawio

1 page(s): [0] 研究流程 (6n/5e)
...
|---|---|---|---|---|---|---|
| n0 | 原始资料 | rect | 0 | 1 | 0/1 | 60,100 180×80 |
| n1 | 提取关系 | rect | 0 | 1 | 1/1 | 320,136 180×80 |
| n2 | 核实事实 | rect | 0 | 1 | 1/1 | 580,100 180×80 |
| n3 | 整理图规格 | rect | 0 | 1 | 1/1 | 840,136 180×80 |
| n4 | 生成图形 | rect | 0 | 1 | 1/1 | 1100,100 180×80 |
| n5 | 检查与导出 | rect | 0 | 1 | 1/0 | 1360,136 180×80 |
