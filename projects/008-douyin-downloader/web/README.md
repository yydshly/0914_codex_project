...
包括路径切换、身份解释、功能原理、输出结构、全景图、效果边界和文档下载。构建脚本按白名单复制网页、图片与文档，校验资源和锚点。`dist/` 不进入版本控制，使用相对路径，可接总仓库 GitHub Pages。已通过 GitHub Pages 发布并验证：[在线导读](https://yydshly.github.io/0914_codex_project/008-douyin-downloader/)。线上 12 个文件与本地构建逐项比对一致，总导航及 001–008 八个项目入口返回 HTTP 200。
